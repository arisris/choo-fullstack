...
module.exports = function (state, emit) {
  ...
  return html`
    <div class="db bg-purple white shadow-1">
      <div
        class="flex flex-column flex-row-l justify-between-l mw8-l"
        style="margin:auto"
      >
        <div class="flex justify-between items-center h2">
          ...
          <div class="pr2 dn-l">
            <a
              href="#"
              class="db pa1 ba white hover-bg-black-10 b--white-10 no-underline"
              onclick="${toggleMenu}"
              >Menu</a
            >
          </div>
        ...
        <div
          class="${menu.active
            ? "flex"
            : "dn"} flex-l flex-column flex-row-l items-center-l mv1 mv0-l bt bn-l b--white-10 z-5 z-unset-l"
        >
          ${user
            ? html`
